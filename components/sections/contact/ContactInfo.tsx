          ...
          >
            ...
            >
              <a
                ...
                className="font-merriweather-sans text-contact-info-detail text-contact-detail-ink underline decoration-from-font transition-opacity hover:opacity-80 active:opacity-70 focus-visible:rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-contact-detail-ink"
                style={{ wordBreak: "break-word" }}
              >
                {resolved.email}
              </a>
              <p className="font-merriweather-sans text-contact-info-detail text-contact-detail-ink">
                {resolved.phone}
              </p>
            </div>
